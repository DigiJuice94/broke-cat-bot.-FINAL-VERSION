...
export const config={
  ...
  livePositionUsd:n('LIVE_POSITION_USD',2), // legacy/fallback only when AUTO_POSITION_SIZING=false
  autoPositionSizing:b('AUTO_POSITION_SIZING',true),
  autoSizeMinWalletPct:n('AUTO_SIZE_MIN_WALLET_PCT',10),
  autoSizeMaxWalletPct:n('AUTO_SIZE_MAX_WALLET_PCT',100),
  autoSizeMinTradeUsd:n('AUTO_SIZE_MIN_TRADE_USD',0.50),
  minSolReserve:n('MIN_SOL_RESERVE',0.0015),
  ...
  geckoTerminalPages:n('GECKOTERMINAL_PAGES',2),
  geckoTerminalCandidateLimit:n('GECKOTERMINAL_CANDIDATE_LIMIT',40),
  geckoTerminalTimeoutMs:n('GECKOTERMINAL_TIMEOUT_MS',10000),
  dexScreenerFallback:b('DEXSCREENER_FALLBACK',true),
